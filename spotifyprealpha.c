...
void listar_albuns(int op, int id_artista, char *titulo, RepMusica *rep);
...
int main() {
    ...
    char menus[][25] = {"1. Gerenciar artistas", "2. Gerenciar albuns", "3. Gerenciar musicas", "4. Sair", "Digite a opcao: "};
    char menuCrud[][25] = {"1. Cadastrar", "2. Buscar", "3. Listar", "4. Atualizar", "5. Remover", "6. Cancelar", "Digite a opcao: "};
    char menuFiltrarArtista[][25] = {"1. Mostrar todos", "2. Filtrar por nome", "3. Cancelar", "Digite a opcao: "};
    char menuFiltrarMusica[][25] = {"1. Mostrar todos", "2. Filtrar por título", "3. Filtrar por artista", "4. Filtrar por album", "5. Filtrar por gênero", "6. Cancelar", "Digite a opcao: "};
    char menuFiltrarAlbum[][25] = {"1. Mostrar todos", "2. Filtrar por título", "3. Filtrar por artista", "4. Cancelar", "Digite a opcao: "};
                        ...
                        for (i = 0; i < repositorio.artistas.index; i++) {
                            switch (op) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    if (strstr(repositorio.artistas.artistas[i].nome, nome) != NULL) {
                                        exibir_artista(i, &repositorio);
                                    }
                                case 3:
                                    break;
                                default:
                                    pritf("Opcao invalida\n");
                                    break;
                            }
                        }
                        break;
            ...
            case 2:
                switch (subop) {
                    case 1:
                        ...
                        scanf("%d", &id_artista);
                        registrar_album(construtor_album(titulo, ano, id_artista), &repositorio);
                        break;
                    case 2:
                        printf("Id: ");
                        scanf("%d", &id);
                    ...
                    case 3:
                        ...
                        switch (filtrarop) {
                            case 1:
                                listar_albuns(1, 0, NULL, &repositorio);
                        }
                    case 4:
                        printf("Id: ");
                        scanf("%d", &id);
            ...
            case 3:
                switch (subop) {
                    case 1:
                        ...
                        printf("Id do Album: ");
                        scanf("%d", &id_album);
                        registrar_musica(construtor_musica(titulo, genero, id_album, h * 60 * 60 + m * 60 + s, faixa), &repositorio);
                        break;
                    case 2:
                        printf("Id: ");
                        scanf("%d", &id);
    ...
    for (i = 0; i < repositorio.musicas.index; i++) {
        switch (op) {
            case 1:
                ...
                break;
            case 2:
                if (strstr(repositorio.musicas.musicas[i].titulo, titulo) != NULL) {
                    exibir_musica(i, &repositorio);
                }
                break;
            case 3:
                if (buscar_artista(id_artista, &repositorio) != -1) {
                    int indexalbum = buscar_album(repositorio.musicas.musicas[i].id_album, &repositorio);
                    if (repositorio.albuns.albuns[indexalbum].id_artista == id_artista) {
                        exibir_musica(i, &repositorio);
                    }
                } else {
                    printf("Artista nao encontrado!");
                ...
                break;
            case 4:
                int indexalbum = buscar_album(id_album, &repositorio);
                if (indexalbum != -1) {
                    if (repositorio.musicas.musicas[i].id_album == id_album) {
                        exibir_musica(i, &repositorio);
                    }
                } else {
                    printf("Album nao encontrado!");
                ...
                break;
            case 5:
                if (strstr(repositorio.musicas.musicas[i].genero, genero) != NULL) {
                    exibir_musica(i, &repositorio);
                }
                break;
            case 6:
        ...
        switch (op) {
            ...
            case 3:
                if (buscar_artista(id_artista, rep) != -1) {
                    int indexalbum = buscar_album(rep->musicas.musicas[i].id_album, rep);
                ...
                break;
            case 4:
                int indexalbum = buscar_album(id_album, rep);
                if (indexalbum != -1) {
